    ...
    <div class="right_col" role="main" style="background-color: #e6e6e6;">
		...
		<div class="x_content">
            <ul class="nav nav-tabs bar_tabs" role="tablist">
				...
				<li role="presentation" class="active"><a href="{!! url('admin/customer/add')!!}"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i> <b>{{ trans('app.Add Customer') }}</b></a></li>
            </ul>
		</div>
		<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
						<form id="demo-form2" action="{!! url('admin/customer/store')!!}" method="post"

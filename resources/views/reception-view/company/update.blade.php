	...
	<div class="right_col" role="main">
		...
		<div class="x_content">
            <ul class="nav nav-tabs bar_tabs" role="tablist">
				...
				<li role="presentation" class="active"><a href="{!! url('/admin/customer/list/edit/'.$editid)!!}"><span class="visible-xs"></span><i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp;</i> <b>{{ trans('app.Edit Customer')}}</b></a></li>
            </ul>
		</div>

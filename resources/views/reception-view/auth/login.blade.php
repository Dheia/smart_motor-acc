...
<style>
.login_form{background: #fff;box-shadow: 0 6px 12px rgb(140 152 164 / 8%);border-radius: 0.75rem;}
        ...
        <div class="animate form login_form">
			...
			<div class="loginlogo" style="">
			  ...
			  <img src="{{ URL::asset('public/general_setting/'.getLogoSystem())}}"
			   alt="Garage Management System" style="margin-top:20px; width : 250px; object-fit: contain;margin-left: 53px;"></a>
			</div>

			<section class="login_content">
            <form class="form-horizontal" method="POST" action="{{ url('reception/auth/login') }}">
                 {{ csrf_field() }}
              <h1 class="logintextcolor">Login Form</h1>
              <div class="loginpading {{ $errors->has('username') ? ' has-error' : '' }}">

       ...
       <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title hidden-xs" style="border: 0; ">
              <a href="{!! url('/reception')!!}" class="site_title" style="padding-top: 10px;padding-bottom: 10px;">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{!! url('/reception') !!}"><i class="fa fa-home"></i> {{ trans('app.Dashboard')}} </a> </li>
                  ...
                  <li><a><i class="fa fa-edit"></i> {{ trans('app.Users')}} <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        ...
                        <li><a href="{!! url('/company/list')!!}">{{ trans('Companies')}}</a></li>
                    ...
                    <li><a href="{!! url('/supplier/list') !!}"><i class="fa fa-users image_icon"></i> {{ trans('app.Supplier')}} </a> </li>
                    <li><a href="{!! url('/section/list') !!}"><i class="fa fa-book image_icon"></i> {{ trans('Sections')}} </a> </li>


                    <li><a href="{!! url('/services/list') !!}"><i class="fa fa-slack image_icon"></i> {{ trans('app.Services')}} </a> </li>

                    <li><a href="{!! url('/insurance/list') !!}"><i class="fa fa-suitcase image_icon"></i> {{ trans('Insurance')}} </a> </li>
            ...
            <div class="sidebar-footer hidden-small">
              <a title="Logout" href="#" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
				...
				<form id="logout-form" action="{{ route('reception.auth.logout') }}" method="get" style="display: none;">
						@csrf
				</form>
              </a>
            </div>

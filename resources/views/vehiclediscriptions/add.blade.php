                 ...
                 <div class="x_content">
                  <div class="x_title">
                     <ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class=""><a href="{!! url('/admin/vehicaldiscriptions/list')!!}"><span class="visible-xs"><i class="ti-info-alt"></i></span> {{ trans('app.VehicalDiscriptions List')}}</a></li>
						<li role="presentation" class="active"><a href="{!! url('/admin/vehicaldiscriptions/add')!!}"><span class="visible-xs"><i class="ti-info-alt"></i></span> {{ trans('app.Add VehicalDiscriptions')}}</a></li>
					</ul>
				  ...
				  <div class="x_panel">
                    <br />
                    <form action="{{ url('/admin/vehicaldiscriptions/store') }}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">

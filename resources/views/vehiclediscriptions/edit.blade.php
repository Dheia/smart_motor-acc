...
@section('content')
 ...
 <div class="right_col" role="main">
          <div class="">
                ...
                <div class="x_content">
                  <div class="x_title">
                     <ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class=""><a href="{!! url('/admin/vehicaldiscriptions/list')!!}"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i> {{ trans('app.VehicalDiscriptions List')}}</a></li>
            ...
            <li role="presentation" class="active"><a href="{!! url('/admin/vehicaldiscriptions/list/edit/'.$editid)!!}"><span class="visible-xs"></span><i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp;</i><b> {{ trans('app.Edit VehicalDiscriptions')}}</b></a></li>
					</ul>

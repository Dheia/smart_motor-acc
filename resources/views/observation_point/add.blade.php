...
<!-- page content -->
		...
		@endif
           ...
           <li role="presentation" class="active"><a href="{!! url('/admin/observation_point/add')!!}"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i><b>{{ trans('app.Add Observation Point')}}</b></span></a></li>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                   ...
                   <div class="x_content">
                    ...
                    <form method="post" action="{!! url('/admin/observation_point/store') !!}" enctype="multipart/form-data"  class="form-horizontal upperform">

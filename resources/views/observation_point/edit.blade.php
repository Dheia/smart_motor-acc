...
<!-- page content -->
		...
		@endif
			...
			<li role="presentation" class=""><a href="{!! url('/admin/observation_point/list')!!}"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i>{{ trans('app.List Of Observation Point')}}</span></a></li>
           ...
           <li role="presentation" class="active"><a href="{!! url('/admin/observation_point/list/edit/'.$editid)!!}"><span class="visible-xs"></span><i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp;</i><b>{{ trans('app.Edit Observation Point')}}</b></span></a></li>

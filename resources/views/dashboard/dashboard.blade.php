				...
				<nav>
					<div class="nav toggle">
						<a id="menu_toggle"><i class="fa fa-bars" style="color:#fff;"></i></a>
							...
							<span class="titleup"> <a href="{!! url('/')!!}"> <img src="{{ URL::asset('public/general_setting/'.getLogoSystem())}}" width="140px" height="45px"  ></a>
							<!-- ( {{ trans('app.Dashboard')}} ) -->
							</span>
...
{{--												<li> <a href="{!! url('setting/general_setting/list') !!}"><span>{{ trans('app.Settings')}}</span></a></li>--}}
									...
									<form id="logout-dash1" action="{{ route('admin.auth.logout') }}" method="get" style="display: none;">
											@csrf
									</form>
								</ul>
						</li>

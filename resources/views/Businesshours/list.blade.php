        ...
        <div class="">
			...
			<div class="x_content">
				<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
					...
					<li role="presentation" class="suppo_llng_li floattab"><a href="{!! url('/admin/setting/general_setting/list')!!}" class="anchor_tag anchr"><span class="visible-xs"></span><i class="fa fa-cogs">&nbsp;</i>{{ trans('app.General Settings')}}</a></li>
					...
					<li role="presentation" class="active suppo_llng_li_add floattab"><a href="{!! url('/admin/setting/hours/list')!!}" class="anchor_tag anchr"><span class="visible-xs"></span><i class="fa fa-hourglass-end">&nbsp;</i><b>{{ trans('app.Business Hours')}}</b></a></li>

						...
						<table id="datatable" class="example table table-striped responsive-utilities jambo_table" style="margin-top:20px; width:100%;">
							...
							<tr>
								...
								<td>
									...
									<a href="{!! url ('/admin/purchase/list/edit/'.$purchases->id) !!}"> <button type="button" class="btn btn-round btn-success">{{ trans('app.Edit')}}</button></a>
									<a url="{!! url('/admin/purchase/list/delete/'.$purchases->id)!!}" class="sa-warning"> <button type="button" class="btn btn-round btn-danger">{{ trans('app.Delete')}}</button></a>
								</td>
							</tr>
							<?php $i++; ?>
							@endforeach

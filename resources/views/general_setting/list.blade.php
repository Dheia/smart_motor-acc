        ...
        <div class="">
			...
			<div class="x_content">
				<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
					...
					<li role="presentation" class="active suppo_llng_li floattab"><a href="{!! url('/admin/setting/general_setting/list')!!}" class="anchor_tag anchr"><span class="visible-xs"></span><i class="fa fa-cogs">&nbsp;</i><b>{{ trans('app.General Settings')}}</b></a></li>

					<li role="presentation" class="suppo_llng_li_add floattab"><a href="{!! url('/admin/setting/timezone/list')!!}" class="anchor_tag anchr"><span class="visible-xs"></span><i class="fa fa-cog">&nbsp;</i>{{ trans('app.Other Settings')}}</a></li>

					<li role="presentation" class="suppo_llng_li_add floattab"><a href="{!! url('/admin/setting/accessrights/list')!!}" class="anchor_tag anchr"><span class="visible-xs"></span><i class="fa fa-universal-access">&nbsp;</i> {{ trans('app.Access Rights')}}</a></li>

					<li role="presentation" class="suppo_llng_li_add floattab"><a href="{!! url('/admin/setting/hours/list')!!}" class="anchor_tag anchr"><span class="visible-xs"></span><i class="fa fa-hourglass-end">&nbsp;</i>{{ trans('app.Business Hours')}}</a></li>
            ...
            <div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_content">
							<form method="post" action="{{ url('/admin/setting/general_setting/store') }}" enctype="multipart/form-data" class="form-horizontal upperform">
								...
								<div class="form-group col-md-12 col-sm-12 col-xs-12  has-feedback">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select class="form-control  select_country" name="country_id" countryurl="{!! url('/admin/getstatefromcountry') !!}" required>
								...
								<div class="form-group col-md-12 col-sm-12 col-xs-12  has-feedback">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select class="form-control  state_of_country" name="state_id" stateurl="{!! url('/admin/getcityfromstate') !!}">

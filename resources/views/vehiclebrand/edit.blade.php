					...
					<div class="x_content">
						<div class="">
							<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
								<li role="presentation" class="floattab suppo_llng_li"><a href="{!! url('/admin/vehiclebrand/list')!!}" class="anchr"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i>{{ trans('app.Vehicle Brand List')}}</a></li>
								<li role="presentation" class="active floattab suppo_llng_li_add"><a href="{!! url('/admin/vehiclebrand/list/edit/'.$editid)!!}" class="anchr"><span class="visible-xs"></span> <i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp;</i><b>{{ trans('app.Edit Vehicle Brand')}}</b></a></li>
							</ul>
						</div>

					...
					<div class="x_content">
						<div class="">
							<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
								<li role="presentation" class="floattab suppo_llng_li"><a href="{!! url('/admin/vehiclebrand/list')!!}" class="anchr"><span class="visible-xs"></span> <i class="fa fa-list fa-lg">&nbsp;</i>{{ trans('app.VehicleBrand List')}}</a></li>
								<li role="presentation" class="active floattab suppo_llng_li_add"><a href="{!! url('/admin/vehiclebrand/add')!!}" class="anchr"><span class="visible-xs"></span> <i class="fa fa-plus-circle fa-lg">&nbsp;</i><b>{{ trans('app.Add VehicleBrand')}}</b></a></li>
							</ul>
							<div class="clearfix"></div>
						</div>
						<div class="x_panel">
						<br />
							<form action="{{ url('/admin/vehiclebrand/store') }}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">

			...
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header">
						<a href="{!! url('/admin/customer/list/'.$viewid)!!}"><button type="button" class="close">&times;</button></a>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_content">
					<ul class="nav nav-tabs bar_tabs" role="tablist">
						<li role="presentation" class=""><a href="{!! url('/admin/customer/list')!!}"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp; </i> {{ trans('app.Customer List') }}</a></li>
						<li role="presentation" class="active"><a href="{!! url('/admin/customer/list/'.$viewid)!!}"><span class="visible-xs"></span><i class="fa fa-user">&nbsp; </i><b>{{ trans('app.View Customer') }}</b></a></li>
					</ul>
				</div>
				<div class="row">
                  ...
                  <div class="x_content">
                    ...
                    <article class="media event">
					  ...
					  <?php $view_data = getInvoiceStatus($saless->job_no); ?>
							@if($view_data == "Yes")
								<a href="" data-toggle="modal" f_serviceid="{{$saless->id }}"  url="{!! url('/admin/customer/free-open') !!}"  data-target="#myModal-free-open" print="20" class="freeserviceopen">
							@else
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <article class="media event">
					  ...
					  <?php   $view_data = getInvoiceStatus($saless->job_no); ?>
					   @if($view_data == "Yes")
						<a href="" data-toggle="modal" p_serviceid="{{$saless->id }}"  url="{!! url('/admin/customer/paid-open') !!}"  data-target="#myModal-paid-service" print="20" class="paidservice">
						@else
							@if(!empty(getCustomersactive($userid)=='yes'))
								<a href="" data-toggle="modal" open_customer_id="{{$saless->id }}"  url="{!! url('/admin/service/list/view') !!}"  data-target="#myModal-customer-modal" print="20" class="customeropenmodel">
							@else
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <article class="media event">
					  ...
					  <?php $view_data = getInvoiceStatus($saless->job_no); ?>
							@if($view_data == "Yes")
								 <a href="" data-toggle="modal" r_service="{{$saless->id }}"  url="{!! url('/admin/customer/Repeatjob-modal') !!}"  data-target="#myModal-repeatjob" print="20" class="repeatjobservice">
							@else
								@if(!empty(getCustomersactive($userid)=='yes'))
									<a href="" data-toggle="modal" open_customer_id="{{$saless->id }}"  url="{!! url('/admin/service/list/view') !!}"  data-target="#myModal-customer-modal" print="20" class="customeropenmodel">
								@else

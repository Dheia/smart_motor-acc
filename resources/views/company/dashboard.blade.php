				...
				<nav>
					<div class="nav toggle">
						<a id="menu_toggle"><i class="fa fa-bars" style="color:#fff;"></i></a>
							...
							<span class="titleup"> <a href="{!! url('/admin')!!}"> <img src="{{ URL::asset('public/general_setting/'.getLogoSystem())}}" width="140px" height="45px"  ></a>
							<!-- ( {{ trans('app.Dashboard')}} ) -->
							</span>
						...
						<li class="">
							...
							@endif
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a href="{!!url('/admin/setting/profile')!!}"> {{ trans('app.Profile')}}</a></li>
								<?php $userid=Auth::User()->id;?>
										 @if (getAccessStatusUser('Settings',$userid)=='yes')
											@if(getActiveAdmin($userid)=='yes')
												<li> <a href="{!! url('/admin/setting/general_setting/list') !!}"><span>{{ trans('app.Settings')}}</span></a></li>
											@else
												<li> <a href="{!! url('/admin/setting/timezone/list') !!}"><span>{{ trans('app.Settings')}}</span></a></li>
											@endif
										@endif
									...
									<form id="logout-dash" action="{{ route('admin.auth.logout') }}" method="get" style="display: none;">
											@csrf
									</form>
								</ul>
						</li>
...
{{--												<li> <a href="{!! url('setting/general_setting/list') !!}"><span>{{ trans('app.Settings')}}</span></a></li>--}}
									...
									<form id="logout-dash1" action="{{ route('admin.authlogout') }}" method="get" style="display: none;">
											@csrf
									</form>
								</ul>
						</li>
				...
				@if(!empty($sale))
				   @foreach($sale as $saless)
						<div class="x_content">
							...
							@if($view_data == "Yes")
							  <a href="" data-toggle="modal" open_id="{{$saless->id }}"  url="{!! url('/admin/dashboard/open-modal') !!}"  data-target="#myModal-open-modal" print="20" class="openmodel">
							@else
								@if(!empty(getActiveEmployee($userid)=='yes'))
									<a href="{!! url('/admin/jobcard/list/'.$saless->id) !!}">
								@else
									<a href="" data-toggle="modal" open_customer_id="{{$saless->id }}"  url="{!! url('/admin/service/list/view') !!}"  data-target="#myModal-customer-modal" print="20" class="customeropenmodel">
								@endif
				   ...
				   @if(!empty($sale1))
					   @foreach($sale1 as $sale1s)
							...
							?>
								...
								@if($view_data == "Yes")
									<a href="" data-toggle="modal" c_service="{{ $sale1s->id }}"  url="{!! url('/admin/dashboard/view/com-modal') !!}"  data-target="#myModal-com-service" print="20" class="completedservice">
							    @else
									@if(!empty(getActiveEmployee($userid)=='yes'))
										<a href="{!! url('/admin/jobcard/list/'.$sale1s->id) !!}">
									@else
									<a href="" data-toggle="modal" open_customer_id="{{$sale1s->id }}"  url="{!! url('/admin/service/list/view') !!}"  data-target="#myModal-customer-modal" print="20" class="customeropenmodel">
									@endif
								@endif
								  <div class="media-body">
					...
					@if(!empty($sale2))
						@foreach($sale2 as $sale2s)
							...
							?>
								...
								@if($view_data == "Yes")
									<a href="" data-toggle="modal" u_service="{{ $sale2s->id }}"  url="{!! url('/admin/dashboard/view/up-modal') !!}"  data-target="#myModal-serviceup" print="20" class="service-up">
								@else
									@if(!empty(getActiveEmployee($userid)=='yes'))
										<a href="{!! url('/admin/jobcard/list/'.$sale2s->id) !!}">
									@else
									<a href="" data-toggle="modal" open_customer_id="{{$sale2s->id }}"  url="{!! url('/admin/service/list/view') !!}"  data-target="#myModal-customer-modal" print="20" class="customeropenmodel">
									@endif
								@endif
									<div class="media-body">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
					<div class="x_panel rjc">
						<div class="x_title">
								...
								<ul class="nav navbar-right panel_toolbox">
									<li><a href="{!! url('/admin/customer/list')!!}"><button type="button" class="btn  btn-default">{{ trans('app.View All')}}</button></a>
									</li>
								</ul>
							<div class="clearfix"></div>
						</div>

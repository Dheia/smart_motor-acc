...
class Customcontroller extends Controller
{
	...
	public function store()
	{
		...
		return redirect('/admin/setting/custom/list')->with('message','Successfully Submitted');
	}
	...
	public function delete($id)
	{
		...
		return redirect('/admin/setting/custom/list')->with('message','Successfully Deleted');
	}
	...
	public function update($id)
	{
		...
		$tbl_custom_fields->save();
		return redirect('/admin/setting/custom/list')->with('message','Successfully Updated');
	}
}

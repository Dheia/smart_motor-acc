...
class Customercontroller extends Controller
{
	...
	public function storecustomer(Request $request)
	{
		 ...
		 'emirates_id' => 'required|unique:users',
		 ],[
        ...
        if (empty($email))
        {
		    ...
		    return redirect('/admin/customer/list')->with('message','Successfully Submitted');
	}
    ...
    public function destory($id)
	 {
		...
		return redirect('/admin/customer/list')->with('message','Successfully Deleted');
	 }

...
class Accountantcontroller extends Controller
{
	...
	public function storeaccountant(Request $request)
	{
		...
		$city=Input::get('city');
		    ...
		    return redirect('/admin/accountant/list')->with('message','Successfully Submitted');
	}
	...
	public function accountantshow($id)
	{
		...
		return view('accountant.view',compact('accountant','viewid','sales','service','vehicale','salese','servic'));
	}
	...
	public function destory($id)
	 {
		...
		return redirect('/admin/accountant/list')->with('message','Successfully Deleted');
	 }
    ...
    public function accountantupdate($id, Request $request)
	{
		...
		$city=Input::get('city');
		    ...
		    return redirect('/admin/accountant/list')->with('message','Successfully Updated');
	}
}

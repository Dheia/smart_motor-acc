...
class ObservationTypecontroller extends Controller
{
	...
	public function store(Request $request)
	{
		...
		$o_point->save();
		return redirect('/admin/observation_type/list')->with('message','Successfully Submitted');
	}
	...
	public function destroy($id)
	{
		...
		return redirect('/admin/observation_type/list')->with('message','Successfully Deleted');
	}
	...
	public function update($id)
	{
		...
		$o_point->type = Input::get('o_type');
		$o_point->save();
		return redirect('/admin/observation_type/list')->with('message','Successfully Updated');
	}
}

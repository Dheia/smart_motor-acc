...
class employeecontroller extends Controller
{
   ...
   public function employeelist()
   {
       ...
       $users = DB::table('users')->whereIn('role', $roles)->orderBy('id','DESC')->get()->toArray();
   ...
   public function store(Request $request)
   {
			...
			'user_name'=>'required|unique:users|string|max:15|min:4',
			'role'=>'required',
			'password'=>'min:6',
        ...
        if ($role == 'Reception')
        {
            ...
            $Reception->name =$name;
            $Reception->number = $contact_no;
            $Reception->username = $user_name;
            $Reception->password=bcrypt($password);
            $Reception->is_block="0";
            $Reception->save();
        }
		...
		return redirect('/admin/employee/list')->with('message','Successfully Submitted');
	}
	...
	public function update($id ,Request $request)
	{
		...
		return redirect('/admin/employee/list')->with('message','Successfully Updated');
	}
	...
	public function destory($id)
	{
        ...
        return redirect('/admin/employee/list')->with('message','Successfully Deleted');
	}

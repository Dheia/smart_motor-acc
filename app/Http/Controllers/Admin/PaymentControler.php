...
class PaymentControler extends Controller
{
	...
	public function paymentstore()
	{
		...
		if($count == 0)
		{
			...
			$payment->save();
			return redirect('/admin/payment/list')->with('message','Successfully Submitted');
		}
		else
		{
			return redirect('/admin/payment/add')->with('message','Duplicate Data');
		}
	}
    ...
    public function destory($id)
    {
    	...
    	return redirect('/admin/payment/list')->with('message','Successfully Deleted');
    }
    ...
    public function updatepayment($id)
    {
		...
		if($count == 0)
		{
			...
			$payment->payment=$paymenttype;
			$payment->save();
			return redirect('/admin/payment/list')->with('message','Successfully Updated');
		}
		else
		{
			return redirect('/admin/payment/list/edit/'.$id)->with('message','Duplicate Data');
		}
    }
}

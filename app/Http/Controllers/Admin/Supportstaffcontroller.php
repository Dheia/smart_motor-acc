...
class Supportstaffcontroller extends Controller
{
	...
	public function store_supportstaff(Request $request)
	{
		...
		$city=Input::get('city');
		    ...
		    return redirect('/admin/supportstaff/list')->with('message','Successfully Submitted');
	}
	...
	//supportstaff delete
     public function destory($id)
	 {
		  ...
		  return redirect('/admin/supportstaff/list')->with('message','Successfully Deleted');
	 }
    ...
    public function update($id, Request $request)
	{
		...
		$city=Input::get('city');
		    ...
		    return redirect('/admin/supportstaff/list')->with('message','Successfully Updated');
	}
}

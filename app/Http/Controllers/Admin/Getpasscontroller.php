...
class Getpasscontroller extends Controller
{
	...
	public function store(Request $request){
		...
		$gatepass->save();
		return redirect('/admin/gatepass/list')->with('message','Successfully Submitted');
	}
	...
	public function delete($id)
	{
		...
		return redirect('/admin/gatepass/list')->with('message','Successfully Deleted');
	}
	...
	public function upadte(Request $request,$id)
	{
        ...
        $gatepass->create_by = Auth::user()->id;
		$gatepass->save();
		return redirect('/admin/gatepass/list')->with('message','Successfully Updated');
	}

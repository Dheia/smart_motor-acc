...
class Productcontroller extends Controller
{
	...
	public function store(Request $request)
	{
		...
		return redirect('/admin/product/list')->with('message','Successfully Submitted');
	}
	...
	public function destroy($id)
	{
		...
		return redirect('/admin/product/list')->with('message','Successfully Deleted');
	}
	...
	public function update(Request $request ,$id)
	{
		...
		return redirect('/admin/product/list')->with('message','Successfully Updated');
	}

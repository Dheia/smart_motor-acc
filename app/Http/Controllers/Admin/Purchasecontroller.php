...
class Purchasecontroller extends Controller
{
	...
	public function store()
	{
		...
		return redirect('/admin/purchase/list')->with('message','Successfully Submitted');
	}
	...
	public function destory($id)
	{
		...
		return redirect('/admin/purchase/list')->with('message','Successfully Deleted');
	}
	...
	if(!empty($products))
	{
		...
		return redirect('/admin/purchase/list')->with('message','Successfully Updated');
	}

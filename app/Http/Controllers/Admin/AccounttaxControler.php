...
class AccounttaxControler extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if($count == 0)
		{
			...
			$account->tax = $tax;
			$account->save();
			return redirect('/admin/taxrates/list')->with('message','Successfully Submitted');
		}
		else
		{
			return redirect('/admin/taxrates/add')->with('message','Duplicate Data');
		}
	}
	...
	public function destory($id)
	{
		...
		return redirect('/admin/taxrates/list')->with('message','Successfully Deleted');
	}
	...
	public function updateaccount(Request $request,$id)
	{
		...
		if($count == 0)
		{
			...
			$account->tax = $tax;
			$account->save();
			return redirect('/admin/taxrates/list')->with('message','Successfully Updated');
		}
		else
		{
			return redirect('/admin/taxrates/list/edit/'.$id)->with('message','Duplicate Data');
		}
	}
}

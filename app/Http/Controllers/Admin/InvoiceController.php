...
class InvoiceController extends Controller
{
	...
	public function store()
	{
		...
		if(!empty($type == 2))
		{
			...
			return redirect('/admin/sales_part/list')->with('message','Successfully Submitted');
		}
		return redirect('/admin/invoice/list')->with('message','Successfully Submitted');
	}
	...
	public function update($id)
	{
		...
		if($amount_recevied == $paidamount )
		{
			...
			return redirect('/admin/invoice/list')->with('message','Successfully Updated');;
	}
	...
	public function destroy($id)
	{
		...
		return redirect('/admin/invoice/list')->with('message','Successfully Deleted');;
	}

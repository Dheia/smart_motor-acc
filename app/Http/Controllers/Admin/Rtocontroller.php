...
class Rtocontroller extends Controller
{
	...
	public function store(Request $request)
	{
		...
		return redirect('/admin/rto/list')->with('message','Successfully Submitted');
	}
	...
	public function destroy($id)
	{
		...
		return redirect('/admin/rto/list')->with('message','Successfully Deleted');
	}
	...
	public function update(Request $request ,$id)
	{
		...
		$rto->muncipal_road_tax = Input::get('mun_tax');
		$rto->save();
		return redirect('/admin/rto/list')->with('message','Successfully Updated');
	}
}

...
class Languagecontroller extends Controller
{
	...
	public function store1()
	{
		...
		return redirect('/admin/setting/language/direction/list')->with('message','Successfully Updated');
	}
	...
	public function store()
	{
		...
		return redirect('/admin/setting/timezone/list')->with('message','Successfully Updated');

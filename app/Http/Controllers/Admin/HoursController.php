...
class HoursController extends Controller
{
	...
	public function hours(Request $request)
	{
		...
		if($start <= $to)
		{
			if($tbl_business_hours == 0)
			{
				...
				return redirect('/admin/setting/hours/list')->with('message','Successfully Submitted');
			}
			else
			{
				...
				return redirect('/admin/setting/hours/list')->with('message','Successfully Updated');
			}
		}
        else
		{
			return redirect('/admin/setting/hours/list')->with('message1','Please select time which is greater than start time');
		}
	...
	public function holiday()
	{
		...
		{
			return redirect('/admin/setting/hours/list')->with('message1','Date is already inserted');
		}
	}
	...
	public function deleteholiday($id)
	{
		...
		return redirect('/admin/setting/hours/list')->with('message','Successfully Deleted');
	}

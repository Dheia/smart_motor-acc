...
class ExpenseController extends Controller
{
	...
	public function store()
    {
		...
		return redirect('/admin/expense/list')->with('message','Successfully Submitted');
	}
    ...
    public function update(Request $request, $id)
    {
		...
		return redirect('/admin/expense/list')->with('message','Successfully Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect("/admin/expense/list")->with('message','Successfully Deleted');
    }

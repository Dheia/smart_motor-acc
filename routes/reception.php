...
Route::group(['namespace' => 'Reception', 'as' => 'reception.'], function () {
...
Route::get('/dashboard', ['middleware'=>'Reception','uses'=>'HomeController@dashboard'])->name('dashboard');
...
//Purchase
Route::group(['prefix'=>'purchase','middleware'=>'Reception'],function(){
...
//Stoke
Route::group(['prefix'=>'stoke','middleware'=>'Reception'],function(){
...
// Customer
Route::group(['prefix'=>'customer','middleware'=>'Reception'],function(){
...
Route::group(['prefix'=>'company','middleware'=>'Reception'],function(){
...
//Accountant
Route::group(['prefix'=>'accountant','middleware'=>'Reception'],function(){
...
//Sections
Route::group(['prefix'=>'section','middleware'=>'Reception'],function(){
...
//Services
Route::group(['prefix'=>'services','middleware'=>'Reception'],function(){
...
//insurance
Route::group(['prefix'=>'insurance','middleware'=>'Reception'],function(){
...
Route::group(['prefix'=>'vehicle','middleware'=>'Reception'],function(){
...
// vehical type
 ...
 Route::group(['prefix'=>'vehicletype','middleware'=>'Reception'],function(){
 ...
 //vehical brand
  ...
  Route::group(['prefix'=>'vehiclebrand','middleware'=>'Reception'],function(){
...
// Vehical Discriptions
 ...
 Route::group(['prefix'=>'vehicaldiscriptions','middleware'=>'Reception'],function(){
...
Route::group(['prefix'=>'payment','middleware'=>'Reception'],function(){
...
Route::group(['prefix'=>'taxrates','middleware'=>'Reception'],function(){
...
//Services
Route::group(['prefix'=>'service','middleware'=>'Reception'],function(){
  ...
  Route::get('get_user_data',['as'=>'service/get_user_data','uses'=>'ServicesControler@get_user_data']);
  Route::get('open/{id}',['as'=>'service/open/{id}','uses'=>'ServicesControler@open']);
  Route::get('get_vehicle_data',['as'=>'service/add','uses'=>'ServicesControler@get_vehicle_data']);
  ...
  Route::POST('/companyadd','ServicesControler@companyadd');
  Route::get('/vehicleadd','ServicesControler@vehicleadd');
});

//Invoice

Route::group(['prefix'=>'invoice','middleware'=>'Reception'],function(){
...
//Supllier
Route::group(['prefix'=>'supplier','middleware'=>'Reception'],function(){
...
Route::group(['prefix'=>'setting','middleware'=>'Reception'],function(){
...
Route::get('/supplier/product/{id}', ['middleware'=>'Reception','uses'=>'Suppliercontroller@data']);
...
Route::get('/search',['as'=>'list/jobcard','uses'=>'JobCardcontroller@search']);
Route::post('/search-jobcard',['as'=>'list/jobcard','uses'=>'JobCardcontroller@search2']);
